...
class ToppingTableViewController: UITableViewController, CellProtocol {
    ...
    override func viewDidLoad() {
        ...
        guard let url = Bundle.main.url(forResource: "topping", withExtension: "json"),
            let toppingJSONData = try? Data(contentsOf: url),
            let ingredients = try? JSONDecoder().decode(Array<Ingredient>.self, from: toppingJSONData) else {
