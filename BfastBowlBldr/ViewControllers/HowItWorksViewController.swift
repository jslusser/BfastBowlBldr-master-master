...
Note: As a rule of thumb, I use a total of about 1/2 cup of whatever combination of grain(s) I select.  For the fruit, I usually toss it with a bit of fresh-squeezed lemon (or lime) juice to prevent browning, adding some Vitamin C to the bowl, and I find that it also just brightens up the flavor.
"""
